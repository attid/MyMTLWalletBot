...
| `AGENTS.md`                 | Оглавление для агента: ≤150 строк, только указатели       |
...
| `bot/`                      | Telegram bot: `core/`, `infrastructure/`, `routers/`, `tests/` |
| `webapp/`                   | FastAPI webapp для подписи                                 |
| `shared/`                   | Общие схемы и константы                                    |
