...
def setup_swap_mocks(router_app_context):
    ...
    class SwapMockHelper:
        ...
        def _setup_defaults(self):
            ...
            swap_uc = MagicMock()
            swap_uc.execute = AsyncMock(
                return_value=PaymentResult(success=True, xdr="XDR_SWAP")
            )
...
@pytest.mark.asyncio
async def test_cq_swap_choose_token_from(
    mock_telegram,
    router_app_context,
    setup_swap_mocks,
    mock_horizon,
...
@pytest.mark.asyncio
async def test_cq_swap_choose_token_for(
...
@pytest.mark.asyncio
async def test_cmd_swap_sum_execution(
    mock_telegram,
    router_app_context,
    setup_swap_mocks,
    mock_horizon,
...
@pytest.mark.asyncio
async def test_cq_swap_strict_receive_switch(
    mock_telegram, router_app_context, setup_swap_mocks
):
...
@pytest.mark.asyncio
async def test_cmd_swap_receive_sum_execution(
    mock_telegram,
    router_app_context,
    setup_swap_mocks,
    mock_horizon,
...
@pytest.mark.asyncio
async def test_cq_swap_cancel_offers_toggle(
    mock_telegram, router_app_context, setup_swap_mocks
):
...
@pytest.mark.asyncio
async def test_cmd_swap_start_custom_token(
    mock_telegram, router_app_context, setup_swap_mocks
):
    """
...
@pytest.mark.asyncio
async def test_cmd_swap_text_command(
    mock_telegram,
    router_app_context,
    setup_swap_mocks,
    mock_horizon,
...
@pytest.mark.asyncio
async def test_cmd_swap_text_flexible_syntax(
    mock_telegram,
    router_app_context,
    setup_swap_mocks,
    mock_horizon,
